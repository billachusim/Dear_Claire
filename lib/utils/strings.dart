...
// Onboarding Processes
  ...
  static const String about_alter_ego_slide3 = "Our Alter Ego Pledge:\nBe a true friend, sympathise in their pains, encourage them in their good plans, advise them to stay optimistic and make them feel good about themselves.";
  static const String about_alter_ego_slide4 = "Alter-Ego Mode gives you special access into Claire's DMs so that you too can spread positive vibes by responding to Diary sessions based on your relative subconscious reverberations.";

  static const String what_is_alter_ego_header = " \n\n 🌺 What Is Alter-Ego?";
  static const String what_is_alter_ego_paragraph = " \n Alter Ego is simply defined as a person's secondary or alternative personality. It is also used to refer to an intimate or trusted friend.\nClaire is an alter ego to all the users of Claire Diary app; being able to feel and understand users' thoughts and experiences and influencing their activities and emotions with good advises and happy vibes 🌺";
  static const String what_is_alter_ego_mode_header =  " \n\n\n 🌺 What is Alter-Ego Mode?";
  static const String what_is_alter_ego_mode_paragraph = " \n Alter Ego Mode is a psychical window into the thoughts and experiences of people around the world.\nAs an Alter Ego, you will be able to switch from a regular user of the Dear Claire Diary to different mode that gives you real-time access to assist Claire directly, to read or listen to anonymous diary sessions before anyone else and respond positively to them just as Claire🌺\n\n"
      ...
      "Interested users are requested to top up their Claireloves using the Top Up love button below to establish your token of binding and support for the Dear Claire (Non-profit) Project. Your Top Up will actually be converted and sent to your Claireloves Wallet and can still be cashed out by you anytime in the future.\n\n"
      "After a Successful Top Up, please tap the Request Access button and you'll be taken through Clairentation (a sort of orientation) where you'll be provided with the secret details to access the Alter-Ego Mode.";
  static const String how_does_it_work = "\n\n\n 🌺 How Does it Work?";
  static const String how_does_it_work_paragraph = " \n To Switch to Alter-Ego Mode, simply open the Claire menu and tap the spinning Claire icon 🌺 at the top left of the menu. Wait a second...\n At the (one time only) login screen, type in the Claire Id and Access Code given to you by Claire and Switch In. Alter-Egos Mode is completely anonymous just like the Diary mode.";

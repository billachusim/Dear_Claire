...
// Onboarding Processes
  ...
  static const String how_claire_works_paragraph5 = ' "YOUR SECRETS STAY SECRET NO MATTER WHAT because YOU ARE COMPLETELY ANONYMOUS. Nobody, not even the developers or Claire can know who you are because you only operate with nickname and password and you can change that nickname anytime you want without losing any content of your diary." - Bill Achusim';
  ...
  static const String what_is_alter_ego_mode_paragraph = " \n Alter Ego Mode is a psychical window into the thoughts and experiences of people around the world.\nAs an Alter Ego, you will be able to switch from a regular user of the Claire Diary to a mode like the featured sessions but gives you real-time access to read anonymous diary sessions and respond positively to them, just like Claire🌺\n\n Access to Alter-Ego Mode is currently granted to only females from the age of 16.\n Interested users are requested (not really compulsory) to make a donation using the button below to establish a personal support for the Claire (Non-profit) Project. After a Successful donation or not, please tap the Request Access button and you'll be taken through Clairentation (a sort of orientation) where you'll be provided with the secret details to access the Alter-Ego Mode.";

...
class DiaryDetailsScreen extends StatefulWidget {
  ...
  DiaryDetailsScreen({Key? key, required this.featuredSessionModel}) : super(key: key);

  @override
  _DiaryDetailsScreenState createState() => _DiaryDetailsScreenState(featuredSessionModel);
}
...
class _DiaryDetailsScreenState extends State<DiaryDetailsScreen> {
  ...
  _DiaryDetailsScreenState(this.featuredSessionModel);

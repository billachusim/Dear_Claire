...
class UsersCategorySessions extends StatelessWidget {
  final String visitedCategory;

  UsersCategorySessions({Key? key, required this.visitedCategory}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Material(
      child: Scaffold(
        ...
        body: StreamBuilder(
          stream: getUsersCategorySessions(),

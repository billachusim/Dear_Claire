...
class ChatModel {
  ...
  ChatModel(
      ...
      this.sessionId,
      this.timeCreated,
      required this.timeLastActivity,
      this.title,
      this.moodId,
      this.subMessage,
      this.userAvatarUrl,
  ...
  ChatModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['translatedMessage'] != null && json['translatedMessage'] is Map) {
      translatedMessage = Map<String, dynamic>.from(json['translatedMessage']);
    } else {
      translatedMessage = {};
    }
